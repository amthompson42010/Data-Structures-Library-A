 ...
 * @title: CS 201 Fall 2017 Semester Project Zero
 * @description: Header file for a dynamic array.
 */
...
/**
 * Structure that will be used for a dynamic array.
 * size -> is the dynamic array's size
 * data -> is the dynamic array's data
